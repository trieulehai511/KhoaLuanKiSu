...
@router.post("/accept/{invite_id}", dependencies=[Depends(PathChecker("/invite"))])
...
@router.post("/revoke/{invite_id}", dependencies=[Depends(PathChecker("/invite"))])
...
@router.post("/reject/{invite_id}", dependencies=[Depends(PathChecker("/invite"))])
...
@router.get("/my-invites",dependencies=[Depends(PathChecker("/invite"))])
