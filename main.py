...
from routers import academy, auth, council, group, information, invite, lecturer_profile, progress, student_profile, sys_role, sys_role_function, sys_user_role, sysuser, thesis, function
